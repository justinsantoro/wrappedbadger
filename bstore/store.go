...
//OpenDb opens a badgerStore in dir returning
//and wraps it in a Store type
func OpenDb(dir string) (d *Store, err error) {
	d = new(Store)
...
func (Store *Store) Set(key []byte, value []byte) error {
	return Store.internal.Update(func(txn *badger.Txn) error {
...
func (Store *Store) IterateValues(prefix []byte, f func(v []byte) error) error {
	return Store.internal.View(func(txn *badger.Txn) error {
